...
case class Tree3[+A, AL, AR] private (value: A,
                                      left: Option[Tree3[AL, ?, ?]],
                                      right: Option[Tree3[AR, ?, ?]]):
...
object Tree3:
  def leaf[A](value: A): Tree3[A, Unit, Unit] =
    Tree3[A, Unit, Unit](value, None, None)

  def branch[A, AL, AR](value: A,
                        left: Tree3[AL, ?, ?],
                        right: Tree3[AR, ?, ?]): Tree3[A, AL, AR] =
